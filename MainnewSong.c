...
uint16_t LS_NOTE[(LS_NOTE_PER_VERSE+1) * LS_VERSE_COUNT] = {
	...
	0, NOTE_D4, NOTE_D4, NOTE_D4, NOTE_D4, NOTE_D4, NOTE_G4, NOTE_A4, NOTE_E4, NOTE_E4, NOTE_E4, NOTE_E4, NOTE_E4, NOTE_G4, NOTE_A4,
    0, NOTE_G4, NOTE_E4, NOTE_E4, NOTE_E4, NOTE_F4, NOTE_D4, NOTE_D4, NOTE_C4, NOTE_E4, NOTE_G4, NOTE_G4, NOTE_E4, NOTE_E4, NOTE_E4,
};
int LS_XPOS[(LS_NOTE_PER_VERSE+1) * LS_VERSE_COUNT] = { // X√‡ 
    /* player */  20,  /* 1st verse */  70, 120, 170, 220,  270, 270, 220, 170, 120, 70, 70,  70,  120, 170,
    /* player */ 170,  /* 2nd verse */  220, 270, 270, 270, 270, 220, 170, 120, 70,  70, 70,  70,  120, 170,
    /* player */ 220,  /* 3rd verse */  220, 270, 270, 270, 270, 220, 170, 120, 70, 70, 120, 170,  220, 220,
    /* player */ 220,  /* 3rd verse */  220, 270, 270, 270, 270, 220, 170, 170, 120, 70, 70, 120,  170, 220,
};
int LS_YPOS[(LS_NOTE_PER_VERSE+1) * LS_VERSE_COUNT] = { // y√‡
    /* player */  45,  /* 1st verse */  45,  45,  45, 45, 45, 85, 85, 85, 85, 85, 125, 165, 165, 165,
    /* player */ 165,  /* 2nd verse */ 165, 165, 125, 85, 45, 45, 45, 45, 45, 85, 125, 165, 165, 165,
    /* player */ 165,  /* 3rd verse */ 165, 165, 125, 85, 45, 45, 45, 45, 45, 85,  85,  85,  85, 125,
    /* player */ 125,  /* 3rd verse */ 165, 165, 125, 85, 45, 45, 45, 85, 85, 85, 125, 125. 125, 125,
};
// Î∞ïÏûêÌëúÎäî TODO...
